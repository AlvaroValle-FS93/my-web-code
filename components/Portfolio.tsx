        ...
        {dict.items.map((item, i) => (
          ...
          >
            <div
              ...
              style={
                i === 0
                  ? { backgroundImage: 'url(/circularScore.png)', backgroundSize: 'contain', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }
                  : i === dict.items.length - 1
                  ? { backgroundImage: 'url(/rollStats1.svg)', backgroundSize: 'cover', backgroundPosition: 'center' }
                  : undefined
              }
            >
              {item.badge && (
